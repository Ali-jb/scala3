...
// you  able to fix each with just one import source line

import java.*
sql.Date.valueOf("2010-8-12").toString 
val a = 2
...
import java.io.{Reader, FileReader, FileNotFoundException, File}
...
(new immutable.ListSet[String]).isEmpty

// import scala.collection.mutable
(new mutable.HashMap[String, Int]).put("One", 1)
...
// wheel.hammy.run  ("Squeak, squeak, squeak") 
...
import _root_.labsoln.awesome.laser
